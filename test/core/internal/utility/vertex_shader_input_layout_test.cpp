...
namespace {
    ...
    TEST(Utility_VertexShaderInputLayoutTest, NormalCase_Binding1) {
        Binding binding(vk::VertexInputRate::eVertex, &Vertex1::attribute1, &Vertex1::attribute2);

        EXPECT_EQ(vk::VertexInputRate::eVertex, binding.getInputRate());
    ...
    TEST(Utility_VertexShaderInputLayoutTest, NormalCase_Binding2) {
        Binding binding(vk::VertexInputRate::eVertex, &Vertex2::attribute1, &Vertex2::attribute2);
    ...
    TEST(Utility_VertexShaderInputLayoutTest, NormalCase_InstantiateInputLayout) {
        VertexShaderInputLayout inputLayout({
            Binding { vk::VertexInputRate::eVertex, &Vertex1::attribute1, &Vertex1::attribute2 },
            Binding { vk::VertexInputRate::eInstance, &Vertex2::attribute1, &Vertex2::attribute2 },
        });

        EXPECT_EQ(vk::VertexInputRate::eVertex, inputLayout.getBindings()[0].getInputRate());
        ...
        EXPECT_EQ(vk::VertexInputRate::eVertex, inputLayout.getBindings()[1].getInputRate());
